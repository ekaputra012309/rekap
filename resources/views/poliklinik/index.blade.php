    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add-btn').on('click', function() {
                window.location.href = `/poliklinik/create`;
            });
            ...
            $('#edit-btn').on('click', function() {
                ...
                let id = selected.val();
                window.location.href = `/poliklinik/${id}/edit`;
            });
            ...
            $('#delete-btn').on('click', function() {
                ...
                confirmModal('Are you sure you want to delete selected poliklinik?', function() {
                    $.ajax({
                        url: '/poliklinik/delete-multiple',
                        type: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}',
                            ids: ids
                        ...
                        success: function(res) {
                            ...
                            showToast('Poliklinik deleted successfully!', 'success');
                        },
                        error: function() {

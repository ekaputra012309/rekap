    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add-btn').on('click', function() {
                window.location.href = `/dokter/create`;
            });
            ...
            $('#edit-btn').on('click', function() {
                ...
                let id = selected.val();
                window.location.href = `/dokter/${id}/edit`;
            });
            ...
            $('#delete-btn').on('click', function() {
                ...
                confirmModal('Are you sure you want to delete selected dokter?', function() {
                    $.ajax({
                        url: '/dokter/delete-multiple',
                        type: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}',
                            ids: ids
                        ...
                        success: function(res) {
                            ...
                            showToast('Dokter deleted successfully!', 'success');
                        },
                        error: function() {
